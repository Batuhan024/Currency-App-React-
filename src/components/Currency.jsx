...
let API_KEY = 'fca_live_1ohnv1EUvIYJbKb2Abmi6Y2d8zVvpFPnFDcOAMwb';
...
function Currency() {
  ...
  return (
    ...
    <div>
      ...
      <input value={result} onChange={(e)=> setResult(e.target.value)} type="number" className="result" placeholder="Sonuç" />
    </div>
    <div>
